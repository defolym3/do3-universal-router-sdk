...
import { MixedRouteTrade, MixedRouteSDK } from '@defolym3/do3-router-sdk'
import { Trade as V2Trade, Pair, Route as RouteV2 } from '@defolym3/do3-v2-sdk'
import { Trade as V3Trade, Route as RouteV3, Pool, FeeOptions } from '@defolym3/do3-v3-sdk2'
import { generatePermitSignature, toInputPermit, makePermit, generateEip2098PermitSignature } from './utils/permit2'
import { CurrencyAmount, Percent, TradeType } from '@defolym3/do3-sdk-core'
...
import { PERMIT2_ADDRESS, ROUTER_ADDRESS, TEST_FEE_RECIPIENT_ADDRESS } from './utils/addresses'
import { FORK_BLOCK } from './utils/constants'
...
describe('Uniswap', () => {
  ...
  before(async () => {
    ;({ WETH_USDC_V2, USDC_DAI_V2, WETH_USDC_V3 } = await getUniswapPools(FORK_BLOCK))
  })
  ...
  describe('v2', () => {
    ...
    //       TradeType.EXACT_INPUT
    //     )
    //     const permit = makePermit(USDC.address, inputUSDC, undefined, ROUTER_ADDRESS)
