...
import { MixedRouteTrade, MixedRouteSDK, Trade as RouterTrade } from '@defolym3/do3-router-sdk'
import { Trade as V2Trade, Pair, Route as RouteV2, computePairAddress } from '@defolym3/do3-v2-sdk'
import {
  Trade as V3Trade,
  Pool,
  Route as RouteV3,
  ...
  TICK_SPACINGS,
  FeeAmount,
} from '@defolym3/do3-v3-sdk2'
import { SwapOptions } from '../../src'
import { CurrencyAmount, TradeType, Ether, Token, Percent, Currency, V2_FACTORY_ADDRESSES } from '@defolym3/do3-sdk-core'
...
export const FEE_AMOUNT = FeeAmount.LOW
